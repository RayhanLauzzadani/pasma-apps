...
import 'package:pasma_apps/pages/admin/widgets/admin_dual_action_buttons.dart';
import 'package:pasma_apps/pages/admin/widgets/success_dialog.dart';
import 'package:pasma_apps/pages/admin/widgets/admin_reject_reason_page.dart';
...
class AdminStoreApprovalDetailPage extends StatelessWidget {
  ...
  // Helper untuk membuka/download PDF
  Future<void> _openPdf(BuildContext context, String url) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'File PDF akan dibuka di browser. Anda dapat melihat atau mendownload dokumen dari browser.',
    ...
    // Buka PDF di browser eksternal
    try {
      final uri = Uri.parse(url);
      // PENTING: Gunakan externalApplication agar dibuka di browser default
      ...
      if (!launched && context.mounted) {
        // Jika gagal, coba dengan mode platform default
      ...
      if (context.mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Gagal membuka PDF. Coba copy link: $url'),
            duration: const Duration(seconds: 5),
            action: SnackBarAction(
              label: 'Copy Link',
              textColor: Colors.white,
              onPressed: () {
                // TODO: Implement clipboard copy jika perlu
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Silakan copy link manual dari Firebase Console'),
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Dokumen Transkrip/FRS (klik untuk zoom)
                      Text(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      ktpUrl.isNotEmpty ? "Transkrip_FRS.pdf" : "Belum ada file",
                                      style: GoogleFonts.dmSans(
                                        fontSize: 13,
                                        color: const Color(0xFF373E3C),
