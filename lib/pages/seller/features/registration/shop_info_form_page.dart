...
import 'package:pasma_apps/pages/seller/widgets/logo_instruction_page.dart';
import 'package:pasma_apps/pages/seller/widgets/shop_registration_success_page.dart';
    ...
    try {
      ...
      final shopData = {
        'owner': {
          ...
          'nama': provider.nama,
          'nik': provider.nik,
          'jurusan': provider.jurusan,
          'angkatan': provider.angkatan,
          'bank': provider.bank,
          'rek': provider.rek,
        },
        'ktpUrl': ktpUrl,
