...
import 'package:pasma_apps/pages/seller/features/ads/add_ads.dart';
import 'package:pasma_apps/pages/seller/features/ads/ad_cart.dart';
import 'package:pasma_apps/pages/seller/features/ads/ads_detail_page.dart';
import 'package:pasma_apps/pages/seller/data/services/ad_service.dart';
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (_loadingStore || _store == null)
                          ...
                          : () async {
                              ...
                              if (mounted) _fetchAds(); // Check mounted before fetch
                            },
                      child: Text(
                        '+ Ajukan Iklan',
                        style: GoogleFonts.dmSans(
