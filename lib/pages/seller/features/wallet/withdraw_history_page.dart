...
import 'package:pasma_apps/pages/seller/features/wallet/detail_wallet_seller_succes_page.dart';
import 'package:pasma_apps/pages/seller/features/wallet/verification_withdrawal_page.dart';
import 'package:pasma_apps/pages/seller/features/wallet/failed_withdrawal_page.dart';
import 'package:pasma_apps/pages/seller/features/wallet/withdraw_payment_page.dart';

/// ===== Model =====
enum _SellerTxnType { income, withdraw, refund }
...
class _WithdrawHistoryPageSellerState extends State<WithdrawHistoryPageSeller> {
  ...
  String _query = '';
  int _filterIndex = 0; // 0=Semua, 1=Pemasukan, 2=Penarikan Saldo, 3=Refund
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final incomes = orderSnap.docs.map((d) {
        ...
        return _SellerTxn(
          id: d.id,
          type: isCanceled ? _SellerTxnType.refund : _SellerTxnType.income,
          title: isCanceled ? 'Refund (Komplain)' : 'Pemasukan',
          subtitle: isCanceled ? 'Dana dikembalikan ke buyer #$orderId' : 'Pesanan #$orderId',
          amount: total,
          createdAt: created,
  ...
  List<_SellerTxn> get _filtered {
    ...
    if (_filterIndex == 1) {
      ...
      items = items.where((e) => e.type == _SellerTxnType.refund).toList();
    }
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          // Chips
          _TypeSelector(
            labels: const ['Semua', 'Pemasukan', 'Penarikan Saldo', 'Refund'],
