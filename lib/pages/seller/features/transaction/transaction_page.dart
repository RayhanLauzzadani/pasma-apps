...
import 'package:pasma_apps/pages/seller/widgets/search_bar.dart' as custom_widgets;
import 'package:pasma_apps/pages/seller/widgets/status_selector.dart';

import 'package:pasma_apps/pages/seller/data/models/seller_transaction_card_data.dart';
import 'package:pasma_apps/pages/seller/widgets/seller_transaction_card.dart';
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> _buildQuery(String uid) {
    ...
    switch (_selectedIndex) {
      case 1: // Sukses
        ...
        break;
      case 2: // Tertahan (belum final atau on-hold, termasuk disputed)
        statuses = ['PENDING', 'ON_HOLD', 'PROCESSING', 'DISPUTED'];
        break;
      case 3: // Gagal
